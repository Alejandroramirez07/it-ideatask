...
import com.solvd.it.compAbstract.Employee;
import com.solvd.it.compInterfaces.PerformanceTesting;
import com.solvd.it.exceptions.InvalidHolidaysException;
import com.solvd.it.exceptions.InvalidHourlyRateException;
...
public class Manager extends Employee implements TimeOutForHire.ITEmployee, PerformanceTesting {
    ...
    public String performanceTesting() {
        return "The manager " + name + " wil gest tested according to his/her team management ";
    }
